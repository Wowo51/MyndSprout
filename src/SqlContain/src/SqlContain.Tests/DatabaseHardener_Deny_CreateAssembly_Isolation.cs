...
{
    [TestClass]
    public sealed class DatabaseHardener_Deny_CreateAssembly_Isolation
    {
        [TestMethod]
        public async Task TestMethod()
        {
            ...
            var dbName = $"SqlContain_Isolation_CreateAssembly_{Guid.NewGuid():N}";
            ...
            finally { /* disposed by await using */ }
        }
    }
}
